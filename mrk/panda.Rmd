...
The input files are: 1) an alignment, 2) the annotations (with unique identifiers) of the contigs aligned.
...
Here, we run the statistics on one type of sub-blocks, the genes.
